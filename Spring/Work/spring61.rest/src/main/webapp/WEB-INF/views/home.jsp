...
<body>
    ...
    <p> <a href="./rest/login?userid=userid&passwd=newpass" target="_blank"> /rest/login?userid=userid&passwd=password  </a></p>
    ...
    <p> <a href="./rest/updateuserinfo?id=3i&pw=3p&name=3n&email=3e" target="_blank"> /rest/updateuserinfo </a></p>
    <hr>
