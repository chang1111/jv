...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences pref = getSharedPreferences( AppConstants.FILE_PREFERECE, MODE_PRIVATE);
        boolean loginStatus = pref.getBoolean( AppConstants.LOGIN_STATUS, false);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if( requestCode == REQUEST_CODE_LOGIN && resultCode == RESULT_OK ){
            // 로그인에 성공했을 때.
            boolean loginStatus = data.getBooleanExtra(AppConstants.LOGIN_STATUS, false);
            // menu 보이고 감추기..
